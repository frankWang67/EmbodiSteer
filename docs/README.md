# EmbodiSteer documentation

- [Installation](installation.md) — environment, third-party forks and smoke checks.
- [Dependency boundary](../environment/dependencies.md) — supported runtime
