...
REQUIRED_PATHS = (
    ...
    "environment/environment-real.yaml",
    "environment/base-requirements.txt",
    "environment/simulation-requirements.txt",
    "environment/real-requirements.txt",
    "environment/legacy-requirements.txt",
    "scripts/preflight_real.py",
    "embodisteer/real_config.py",
